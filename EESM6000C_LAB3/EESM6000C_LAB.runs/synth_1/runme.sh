...
HD_PWD='C:/Users/hkjac/EESM6000C_LAB/EESM6000C_LAB.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bram11.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bram11.tcl
